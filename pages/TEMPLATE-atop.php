...
<html>
  <head>
    ...
    <title><?=isset($_PMETA["title"])?$_PMETA["title"]:"Hired Admin"?></title>
    <meta charset="utf-8">
    <meta name="description" content="<?=isset($_PMETA["desc"])?$_PMETA["desc"]:"Hired PHP Jobs Portal"?>">
    ...
    <!-- (A9) COMMON INTERFACE -->
    <script>var cbhost={base:"<?=HOST_BASE?>",admin:"<?=HOST_ADMIN_BASE?>",api:"<?=HOST_API_BASE?>",assets:"<?=HOST_ASSETS?>"};</script>
  ...
  <body class="bg-light">
    ...
    <div id="cb-body" class="d-flex">
      <?php if (isset($_SESS["user"]) && $_SESS["user"]["user_role"]=="A") { ?>
      <!-- (C1) LEFT SIDEBAR -->
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?=HOST_ADMIN_BASE?>users">
              <i class="mi mi-smol">people</i> Users
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?=HOST_ADMIN_BASE?>settings">
              <i class="mi mi-smol">settings</i> Settings
            </a>
          </li>
        </ul>
        <hr>
      ...
      <div class="flex-grow-1">
        ...
        <nav class="d-flex bg-dark text-white p-1">
          ...
          <div class="d-flex align-items-center">
            <a class="btn btn-sm mi text-white" href="<?=HOST_BASE?>">
              compare_arrows
            </a>
