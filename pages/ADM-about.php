<?php require PATH_PAGES . "TEMPLATE-atop.php"; ?>
<h3>HIRED</h3>
<div class="mb-3">OPEN SOURCE PHP JOBS PORTAL</div>
<div class="bg-white border p-3">
  Documentation : <a href="https://code-boxx.com/hired-php-jobs-portal/" target="_blank">Code Boxx</a>
  <br><br>
